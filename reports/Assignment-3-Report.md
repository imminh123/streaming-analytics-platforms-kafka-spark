...
| Kafka   | Message In Per Topic    | Row 2, Col 3    | Insights into the workload distribution across topics and can help identify hotspots or heavily utilized topics.   |
