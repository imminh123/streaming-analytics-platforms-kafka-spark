...
from pyspark.sql.functions import from_json, col, count, sum, avg, current_timestamp, window, round, current_date, concat, lit, date_add
...
info_df_fin = info_df.select("trip_schema.*", "timestamp").withColumn("event_timestamp", current_timestamp())
